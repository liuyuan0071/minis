...
fun ProviderDetailScreen(
    ...
    SettingsScaffold(
        ...
        val isDeepSeekManaged = isDeepSeekInstance(instance)
        SettingsSection(
            ...
            SettingsCardBlock {
                if (isDeepSeekManaged) {
                    // DeepSeek API key is managed by the system — not visible or editable
                    Row(
...
/** Check if a provider instance is the system-managed DeepSeek instance. */
private fun isDeepSeekInstance(instance: com.openminis.app.data.model.ProviderInstance): Boolean =
